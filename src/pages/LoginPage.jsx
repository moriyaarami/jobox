...
const LoginPage = () => {
  ...
  const handleLinkedInLogin = async () => {
    ...
    if (result.success) {
      ...
      setError(result.error || 'שגיאה בהתחברות עם LinkedIn');
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-teal-50 p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          <Alert>
            <AlertDescription>
              <strong>חשבונות לדמו:</strong><br />
              מחפש עבודה: seeker@example.com / password123<br />
              מעסיק: employer@example.com / password123
            </AlertDescription>
          </Alert>
